...
import com.example.fabricasapatos.data.item.FirebaseItemDataSource
import com.example.fabricasapatos.data.item.IItemDataSource
...
interface DataSourceModule {
  ...
  @Singleton
  @Binds
  fun bindItemDataSource(dataSource: FirebaseItemDataSource): IItemDataSource
}